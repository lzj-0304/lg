...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/admin/css/index.css" media="all"/>
</head>
...
<div class="layui-layout layui-layout-admin">
                ...
                <li class="layui-nav-item" id="userInfo">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;"
                               data-url="${ctx}/page/user/userInfo.html"><i class="seraph icon-ziliao"
                                                                            data-icon="icon-ziliao"></i><cite>个人资料</cite></a>
                        </dd>
                        <dd><a href="javascript:;"
                               data-url="${ctx}/page/user/changePwd.html"><i class="seraph icon-xiugai"
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${ctx}/admin/images/face
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${ctx}/page/main.html"><i class="layui-icon"
                                                                               data-icon=""></i><cite>后台首页</cite></a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">系统管理</a>
                    <dl class="layui-nav-child">
                        <a href="javascript:;" data-url="${ctx}/admin/user/index">
                            <i class="layui-icon" data-icon=""></i><cite>用户管理</cite>
                        </a>
                    </dl>
                    <dl class="layui-nav-child">
                        <a href="javascript:;" data-url="${ctx}/admin/role/index">
                            <i class="layui-icon" data-icon=""></i><cite>角色管理</cite>
                        </a>
                    </dl>
                    <dl class="layui-nav-child">
                        <a href="javascript:;" data-url="${ctx}/admin/module/index">
