...
$().ready(function() {
	...
	$(document).ajaxComplete(function(event, request, settings) {
		...
		if (tokenStatus == "accessDenied") {
			...
			if (url.indexOf("/shop/register/") == 0 || url.indexOf("/shop/login/") == 0 || url.indexOf("/shop/cart/") == 0 || url.indexOf("/shop/order/") == 0) {
				showHeaderCartQuantity();
			}
		}
	});
